...
const SideMenu = ({
  ...
  const makeMenuItems = routes => routes.map(({
    ...
    if (subRoutes) {
      return /*#__PURE__*/React.createElement(SubMenu, {
        key: path,
        title: /*#__PURE__*/React.createElement("span", null, renderIt(icon), /*#__PURE__*/React.createElement("span", null, formatPathText(path)))
  ...
  const menuItem = (path, icon, disabled) => {
    const inner = /*#__PURE__*/React.createElement(React.Fragment, null, renderIt(icon), /*#__PURE__*/React.createElement("span", null, formatPathText(path)));
