...
exports.isBiometryTypeSupported_ = exports.retrieveCredentials_ = exports.getSupportedBiometryType_ = exports.loginSave_ = void 0;
...
exports.getSupportedBiometryType_ = getSupportedBiometryType_;

const isBiometryTypeSupported_ = async () => {
  const res = await (void 0).getSupportedBiometryType_();
  return res !== null;
};

exports.isBiometryTypeSupported_ = isBiometryTypeSupported_;
...
exports.retrieveCredentials_ = retrieveCredentials_;
