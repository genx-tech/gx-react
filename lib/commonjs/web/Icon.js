...
function Icon({
  ...
  const appContext = (0, _react.useContext)(_Runtime.AppContext);

  if (type === 'registry') {
    const CachedIcon = _registry[name];
    return /*#__PURE__*/_react.default.createElement(CachedIcon, props);
  }

  if (!appContext.iconFamilies) {
    _Runtime.default.log('error', 'Missing "iconFamilies" in app context!');
