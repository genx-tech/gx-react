...
const SideMenu = ({
  ...
  const makeMenuItems = routes => routes.map(({
    ...
    if (subRoutes) {
      return /*#__PURE__*/_react.default.createElement(SubMenu, {
        key: path,
        title: /*#__PURE__*/_react.default.createElement("span", null, (0, _renderIt.default)(icon), /*#__PURE__*/_react.default.createElement("span", null, formatPathText(path)))
  ...
  const menuItem = (path, icon, disabled) => {
    const inner = /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, (0, _renderIt.default)(icon), /*#__PURE__*/_react.default.createElement("span", null, formatPathText(path)));
