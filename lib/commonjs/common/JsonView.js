...
const JsonView = ({
  ...
  const jsxView = (0, _react.useMemo)(() => buildItem({
    items: view
  }, value, false, undefined, factory), [view, value, factory]);
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, jsxView);
};
